...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 10 nov. 2023 à 16:09
...
INSERT INTO `repas` (`REPAS_ID`, `MAIL`, `DATE`, `TYPE_REPAS`) VALUES
(1, 'test@test.com', '2023-11-01', 'Petit-déjeuner'),
(2, 'test@test.com', '2023-11-01', 'Déjeuner'),
(3, 'test@test.com', '2023-11-01', 'Snack'),
(4, 'test@test.com', '2023-11-10', 'Petit-déjeuner'),
(5, 'test@test.com', '2023-11-01', 'Dîner'),
(6, 'test@test.com', '2023-11-02', 'Petit-déjeuner'),
(7, 'test@test.com', '2023-11-02', 'Déjeuner'),
(8, 'test@test.com', '2023-11-02', 'Snack'),
(9, 'test@test.com', '2023-11-02', 'Dîner'),
(10, 'test@test.com', '2023-11-03', 'Petit-déjeuner'),
(11, 'test@test.com', '2023-11-03', 'Déjeuner'),
(12, 'test@test.com', '2023-11-03', 'Dîner'),
(13, 'test@test.com', '2023-11-04', 'Petit-déjeuner'),
(14, 'test@test.com', '2023-11-04', 'Déjeuner'),
(15, 'test@test.com', '2023-11-04', 'Snack'),
(16, 'test@test.com', '2023-11-04', 'Dîner'),
(17, 'test@test.com', '2023-11-05', 'Petit-déjeuner'),
(18, 'test@test.com', '2023-11-05', 'Déjeuner'),
(19, 'test@test.com', '2023-11-05', 'Dîner'),
(20, 'test@test.com', '2023-11-06', 'Petit-déjeuner'),
(21, 'test@test.com', '2023-11-06', 'Déjeuner'),
(22, 'test@test.com', '2023-11-06', 'Snack'),
(23, 'test@test.com', '2023-11-06', 'Dîner'),
(24, 'test@test.com', '2023-11-07', 'Petit-déjeuner'),
(25, 'test@test.com', '2023-11-07', 'Déjeuner'),
(26, 'test@test.com', '2023-11-07', 'Snack'),
(27, 'test@test.com', '2023-11-07', 'Dîner'),
(28, 'test@test.com', '2023-11-08', 'Petit-déjeuner'),
(29, 'test@test.com', '2023-11-08', 'Déjeuner'),
(30, 'test@test.com', '2023-11-08', 'Dîner'),
(31, 'test@test.com', '2023-11-09', 'Petit-déjeuner'),
(32, 'test@test.com', '2023-11-09', 'Déjeuner'),
(33, 'test@test.com', '2023-11-09', 'Snack'),
(34, 'test@test.com', '2023-11-09', 'Dîner'),
(35, 'test@test.com', '2023-11-10', 'Dîner'),
(36, 'test@test.com', '2023-11-10', 'Déjeuner'),
(37, 'test@test.com', '2023-11-10', 'Snack');

--
-- Déchargement des données de la table `repasaliment`
--

INSERT INTO `repasaliment` (`REPAS_ID`, `ALIMENT`, `QUANTITE`) VALUES
(1, 'Lait d amande', 50),
(1, 'Pomme', 100),
(2, 'Pâtes à la carbonara', 200),
(3, 'Gaufres au miel', 75),
(4, 'Céréales de petit-déjeuner', 150),
(4, 'Lait de soja', 75),
(5, 'Pizza Margherita', 175),
(6, 'Café au lait', 35),
(6, 'Chocolat noir', 25),
(7, 'Choucroute garnie', 200),
(7, 'Saucisse de Francfort', 90),
(8, 'Barre de céréales aux fruits', 30),
(9, 'Poulet à l indienne avec naan', 225),
(10, 'Jus d orange', 40),
(10, 'Yaourt aux fruits', 50),
(11, 'Lieu noir cuit', 100),
(11, 'Risotto aux champignons', 100),
(12, 'Pad Thai aux crevettes', 200),
(13, 'Banane', 75),
(14, 'Pâtes aux champignons et à la crème', 185),
(15, 'Barre de fruits à la framboise', 45),
(16, 'Salade César', 150),
(17, 'Lait écrémé', 40),
(17, 'Poire Williams', 70),
(18, 'Gratin de poisson aux légumes', 150),
(19, 'Saumon grillé avec asperges', 150),
(20, 'Yaourt à la vanille', 50),
(21, 'Ragoût de bœuf aux légumes', 250),
(22, 'Chocolat blanc aux noix de macadamia', 30),
(23, 'Salade de pâtes au pesto', 140),
(24, 'Granola au miel et aux noix', 30),
(24, 'Pomme', 50),
(25, 'Gnocchis à la sauce tomate', 250),
(26, 'Gaufres au miel', 85),
(27, 'Crevettes à la provençale', 100),
(27, 'Pomme de terre', 140),
(28, 'Céréales de petit-déjeuner', 150),
(29, 'Poulet tandoori avec riz basmati', 300),
(30, 'Agneau cuit', 140),
(30, 'Haricots rouges', 100),
(31, 'Banane', 45),
(31, 'Jus d abricot', 40),
(32, 'Tacos au bœuf', 195),
(33, 'Gaufres au miel', 100),
(34, 'Fajitas au bœuf', 220),
(35, 'Hamburger végétarien', 210),
(36, 'Salade niçoise', 175),
(37, 'Barre de chocolat', 50);
